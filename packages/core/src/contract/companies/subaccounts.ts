...
import { z } from 'zod'
import {
    createSubAccounResponseSchema,
    createSubAccountCnpjBodySchema,
    createSubAccountCpfBodySchema,
    listMandatoryDocumentsResponseSchema,
    listSubAccountsParamsSchema,
    listSubAccountsResponseSchema,
    sendMandatoryDocumentsCpfRequestSchema,
    sendMandatoryDocumentsResponseSchema,
    updateSubAccountResponseSchema,
    updateSubAccountsBodySchema,
} from '../../schemas/companies/subaccounts.js'
